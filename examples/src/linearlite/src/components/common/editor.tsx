...
const Editor = ({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: `input prose text-neutral-600 dark:text-neutral-200 prose-sm prose-strong:text-neutral-600 dark:prose-strong:text-neutral-200 prose-p:my-2 prose-ol:my-2 prose-ul:my-2 prose-pre:my-2 w-full max-w-xl font-normal focus:outline-hidden appearance-none editor ${className}`,
      },
    },
