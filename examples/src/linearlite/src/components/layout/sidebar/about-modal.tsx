    ...
    <Modal show={show} setShow={setShow} title="About LinearLite">
      <div className="p-4 text-sm flex flex-col gap-2 text-neutral-500">
        <p>
          ...
          <a href="https://linear.app" target="_blank" className="underline text-orange-600">
            Linear
          </a>
          .
        </p>
        <p>
          It's built using{' '}
          <a href="https://www.livestore.dev" target="_blank" className="underline text-orange-600">
            LiveStore
          </a>
