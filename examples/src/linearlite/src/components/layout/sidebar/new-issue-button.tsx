...
export const NewIssueButton = ({ status }: { status?: Status }) => {
  ...
  return (
    <Button
      ...
      className={`size-8 flex items-center justify-center hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:outline-hidden focus:bg-neutral-100 dark:focus:bg-neutral-800 rounded-lg ${status === undefined ? 'bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 shadow-sm' : ''}`}
    >
