  ...
  return (
    <>
      <MenuTrigger>
        <Button
          aria-label="Menu"
          className="flex items-center text-lg font-bold px-2 h-8 leading-none hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg focus:outline-hidden focus:bg-neutral-100 dark:focus:bg-neutral-800"
        >
        ...
        <Popover className="w-56 ml-1 bg-white dark:bg-neutral-800 rounded-lg shadow-md border border-neutral-200 dark:border-neutral-700 text-sm leading-none">
          <Menu className="focus:outline-hidden">
            <MenuSection key="linearlite" className="p-2">
              ...
              <MenuItem
                ...
                className="p-2 rounded-md hover:bg-neutral-100 focus:outline-hidden focus:bg-neutral-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 cursor-pointer"
              >
                About
              </MenuItem>
            </MenuSection>
            ...
            <MenuSection key="livestore" className="p-2">
              ...
              <MenuItem className="p-2 rounded-md hover:bg-neutral-100 focus:outline-hidden focus:bg-neutral-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 cursor-pointer">
                About
              </MenuItem>
              <MenuItem className="p-2 rounded-md hover:bg-neutral-100 focus:outline-hidden focus:bg-neutral-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 cursor-pointer">
                Documentation
