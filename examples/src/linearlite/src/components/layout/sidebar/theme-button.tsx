  ...
  return (
    <MenuTrigger isOpen={isOpen} onOpenChange={setIsOpen}>
      <Button
        ...
        className="size-8 flex items-center justify-center hover:bg-neutral-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 focus:outline-hidden focus:bg-neutral-100 dark:focus:bg-neutral-800 rounded-lg bg-white border border-neutral-200 dark:border-neutral-700 shadow-sm"
      >
      ...
      <Popover className="bg-white dark:bg-neutral-800 w-40 rounded-lg shadow-md border border-neutral-200 dark:border-neutral-700 text-sm leading-none">
        <Menu className="p-2 focus:outline-hidden" {...keyboardProps}>
          {themeOptions.map(({ id, label, shortcut }) => {
            return (
              <MenuItem
                key={id}
                onAction={() => selectTheme(id)}
                className="group/item p-2 rounded-md flex items-center gap-2 hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-neutral-100 dark:focus:bg-neutral-700 cursor-pointer"
              >
