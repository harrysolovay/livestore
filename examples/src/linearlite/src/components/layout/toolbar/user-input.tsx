  ...
  return (
    <div className={`lg:h-full flex items-center gap-1 ${className}`}>
      ...
      <Input
        ...
        className="h-6 px-1.5 bg-transparent bg-neutral-800 hover:bg-neutral-700 border-none text-xs rounded-sm placeholder:text-neutral-500 text-neutral-300 grow lg:grow-0 lg:w-28 focus:outline-hidden focus:ring-0 focus:border-none focus:bg-neutral-700"
      />
    </div>
  )
}
