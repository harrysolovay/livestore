  ...
  return (
    <div className={`flex items-center ${className}`}>
      ...
      <Switch
        ...
        className="group flex h-6 items-center gap-2 bg-neutral-800 hover:bg-neutral-700 rounded-sm pl-1 pr-1.5 focus:outline-hidden focus:bg-neutral-700 cursor-pointer"
      >
